...
import com.example.demo.Repositories.OrderrItemRepository;
...
public class PaymentService {
    ...
    private final OrderrItemRepository orderItemRepository;
    private final CartRepository cartRepository;

    public PaymentService(OrderRepository orderRepository, OrderrItemRepository orderItemRepository, CartRepository cartRepository) {
    ...
    public boolean verifyPayment(String razorpayOrderId, String razorpayPaymentId, String razorpaySignature, int userId) {
        try {
            ...
            if (isSignatureValid) {
                ...
                List<CartItem> cartItems = cartRepository.findCartItemsWithProductDetails1(userId);
